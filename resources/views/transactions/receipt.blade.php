...
<body>
    ...
    <div class="text-center no-print" style="margin-top: 20px;">
        <button onclick="window.print()" style="padding: 10px 20px; cursor: pointer; display: inline-flex; items-center: center; gap: 8px; font-weight: bold; background: #1e293b; color: #ffffff; border: none; border-radius: 8px;">
